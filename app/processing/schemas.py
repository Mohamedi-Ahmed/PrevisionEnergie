...
DEFAULT_COLUMN_ALIASES = {
    ...
    "region": ["region", "area", "zone", "nom_region", "libelle_region"],
    "electricity_consumption": [
        "electricity_consumption",
        "electricity",
        "electricity_mwh",
    ...
    "temperature_min": ["temperature_min", "temp_min", "min_temperature", "tmin"],
    "temperature_max": ["temperature_max", "temp_max", "max_temperature", "tmax"],
    "humidity": ["humidity", "humidite", "relative_humidity"],
    "wind_speed": ["wind_speed", "windspeed", "wind", "vitesse_vent"],
    "precipitation": ["precipitation", "rainfall", "rain", "precipitations"],
}
